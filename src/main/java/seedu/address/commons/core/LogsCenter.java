...
public class LogsCenter {
    ...
    public static void init(Config config) {
        LogsCenter.currentLogLevel = config.getLogLevel();
        LogsCenter.logger.info("Log level will be set as: " + LogsCenter.currentLogLevel);
        // set the level of the baseLogger which will be inherited by other loggers
        LogsCenter.baseLogger.setLevel(LogsCenter.currentLogLevel);
    }
    ...
    public static Logger getLogger(String name) {
        ...
        Logger logger = Logger.getLogger(LogsCenter.baseLogger.getName() + "." + name);
    ...
    public static <T> Logger getLogger(Class<T> clazz) {
        ...
        return LogsCenter.getLogger(clazz.getSimpleName());
    }
    ...
    private static void setBaseLogger() {
        ...
        LogsCenter.removeHandlers(LogsCenter.baseLogger);
        ...
        try {
            FileHandler fileHandler = new FileHandler(LogsCenter.LOG_FILE, LogsCenter.MAX_FILE_SIZE_IN_BYTES,
                    LogsCenter.MAX_FILE_COUNT, true);
