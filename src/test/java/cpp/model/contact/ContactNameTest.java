...
public class ContactNameTest {
    ...
    public void isValidName() {
        ...
        Assertions.assertFalse(ContactName.isValidName("Mary-Jane")); // hyphen not allowed
        Assertions.assertFalse(ContactName.isValidName("-James")); // starts with hyphen
        Assertions.assertFalse(ContactName.isValidName("John (Doc) Smith")); // parentheses not allowed
